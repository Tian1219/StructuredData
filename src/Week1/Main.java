...
public class Main {
	...
	// write your code here
      ...
      String A = test2.encryptTwoKeys("Top ncmy qkff vi vguv vbg ycpx",26-2,26-20);
  ...
  //    String B = test3.decrypTwoKeys("Akag tjw Xibhr awoa aoee xakex znxag xwko");
  //     System.out.println(B);
       // test3.testdecryptTwoKeys();
